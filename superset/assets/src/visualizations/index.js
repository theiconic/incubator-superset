...
export const VIZ_TYPES = {
  ...
  report_generator_ui: 'report_generator_ui',
  rose: 'rose',
};
...
const vizMap = {
  ...
  [VIZ_TYPES.report_generator_ui]: () => loadVis(import(/* webpackChunkName: "report_generator_ui" */ './ReportGeneratorUI/adaptor.jsx')),
