...
celery flower --app=superset.sql_lab:celery_app --broker=amqp://${SUPERSET_AMQP_USER}:${SUPERSET_AMQP_PASSWORD}@${SUPERSET_AMQP_HOST}:${SUPERSET_AMQP_PORT}/${SUPERSET_AMQP_VHOST}